...
Em cada um dos Problemas 5 e 6, escreva uma equação diferencial da forma $dy/dt = ay + b$ cujas soluções têm o comportamento pedido quando $t \rightarrow \infty$.
