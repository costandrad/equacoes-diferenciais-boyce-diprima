...
Em cada um dos Problemas de 1 a 6 desenhe um campo de direções para as equações diferenciais dada. baseado no campo de direções, determine o comportamento de $y$ quando $t \rightarrow \infty$. Se este comportamento depende o valor inicial de $y$ e $t = 0$, descreva essa dependência.
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \begin{axis}[
        ...
        \addplot[mainColor, samples=50, ultra thick, no markers, domain=0:5] {3/2};
